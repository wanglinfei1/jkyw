<template>
  <section id="PerMan">
    <hgroup>
      <h2><router-link to="/main">首页</router-link> | 人员管理</h2>
    ...
    <template>
      <el-table :data="tableData" style="width:100%">
        ...
        <el-table-column prop="complain" label="初步诊断"></el-table-column>
        <el-table-column inline-template :context="_self" label="操作">
          <span>
            <el-button type="text" @click="watch($index,row)">查看</el-button>
            <el-button type="text" @click="watch($index,row)">编辑</el-button>
            <el-button type="text" @click="watch($index,row)">重置密码</el-button>
          </span>
        </el-table-column>
      </el-table>
    </template>
